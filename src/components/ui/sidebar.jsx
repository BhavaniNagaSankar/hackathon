...
// ----------------------- Sidebar (desktop/mobile rendering) -----------------------
...
const Sidebar = React.forwardRef(({ side = "left", variant = "sidebar", collapsible = "offcanvas", className, children, ...props }, ref) => {
  ...
  // Desktop: collapsible/floating/inset behavior
  return (
    <div
      ref={ref}
      ...
      data-side={side}
    >
      {/* Gap spacer that collapses to zero for offcanvas */}
      <div
        className={cn(
...
const SidebarMenuButton = React.forwardRef(
  (
    ...
    // Tooltip disabled if no tooltip OR sidebar expanded OR mobile
